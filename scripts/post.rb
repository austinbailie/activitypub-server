...
document = {
	...
	"id": "https://activitypub-test-s2ur7rvzga-uc.a.run.app/posts/#{Time.now.utc.iso8601}",
	"type": "Create",
  ...
  "to": ["https://www.w3.org/ns/activitystreams#Public"],
	"object": {
		...
		"attributedTo": "https://activitypub-test-s2ur7rvzga-uc.a.run.app/actors/earlyadopter",
...
actor_url = 'https://activitypub-test-s2ur7rvzga-uc.a.run.app/actors/earlyadopter'
outbox_url = 'https://activitypub-test-s2ur7rvzga-uc.a.run.app/create-post'
